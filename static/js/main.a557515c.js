/*! For license information please see main.a557515c.js.LICENSE.txt */
!(function () {
	'use strict';
	var e = {
			463: function (e, n, t) {
				...
				function $n(e, n) {
					e.blockedOn === n &&
						((e.blockedOn = null),
						Nn || ((Nn = !0), l.unstable_scheduleCallback(l.unstable_NormalPriority, Vn)));
				}
				function Bn(e) {
					function n(n) {
						return $n(n, e);
				...
				function Pu(e, n, t, r, l) {
					...
					if ((_a(n, l), null === n.stateNode)) Bu(e, n), Ba(n, t, r), Wa(n, t, r, l), (r = !0);
					else if (null === e) {
						var o = n.stateNode,
							u = n.memoizedProps;
						o.props = u;
				...
				function ts(e, n, t, r) {
					...
					yn(e, t, r),
						(0 !== (2 & Pi) && e === zi) ||
							...
							rs(e, r),
							1 === t && 0 === Pi && 0 === (1 & n.mode) && (($i = Ge() + 500), jl && $l()));
				}
				function rs(e, n) {
				...
				function ls(e, n) {
					...
					if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || n) n = vs(e, r);
						...
						wa(), (Ei.current = o), (Pi = l), null !== Ti ? (n = 0) : ((zi = null), (Li = 0), (n = Oi));
					}
					if (0 !== n) {
					...
					if (null !== Ki) {
						...
						try {
							if (((Ni.transition = null), (kn = 16 > e ? 16 : e), null === Ki)) var r = !1;
								...
								if (((Pi = l), $l(), an && 'function' === typeof an.onPostCommitFiberRoot))
									try {
	...
	!(function () {
		...
		var u = function (n) {
			var t = n.props,
				...
				f = t.disabled,
				d = void 0 !== f && f,
				p = o((0, e.useState)(s), 2),
				m = p[0],
				h = p[1];
			function v(e) {
				e.preventDefault(), h(!m);
			}
			return (0, r.jsxs)('section', {
				className: d ? 'item__card disabled' : m ? 'item__card selected' : 'item__card',
				children: [
					(0, r.jsx)('a', {
						href: '#',
						onClick: v,
								...
								children: [
									(0, r.jsxs)('div', {
										...
										children: [
											...
											(0, r.jsx)('h5', { className: 'card__sub-title', children: l }),
											(0, r.jsx)('div', {
												className: 'card__features',
												children: a.map(function (e, n) {
													return (0,
													r.jsx)('p', { className: 'card__description', children: e }, n);
												}),
											}),
										],
									}),
									...
									(0, r.jsxs)('div', {
										...
										children: [
											(0, r.jsx)('p', { className: 'mark__weight', children: u }),
											(0, r.jsx)('p', { className: 'mark__dimension', children: '\u043a\u0433' }),
										],
									}),
								],
							}),
					...
					d
						...
						: m
						? (0, r.jsxs)('p', { className: 'card__appeal', children: [c, ' '] })
						: (0, r.jsxs)('p', {
								className: 'card__appeal',
								children: [
				...
				children: [
					...
					(0, r.jsx)('section', {
						...
						children: [
							...
							return (0, r.jsx)(u, { props: e }, n);
						}),
					}),
				],
			});
		};
		n.createRoot(document.getElementById('root')).render((0, r.jsx)(e.StrictMode, { children: (0, r.jsx)(i, {}) }));
	})();
})();
//# sourceMappingURL=main.a557515c.js.map
